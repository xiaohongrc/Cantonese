...
public class Synthesizer {
    ...
    public void initSynthesizer() {
        ...
        String s1 = GloabalParams.SynthesizerLanguage.toString();
        System.out.println("-------------s1-  = "+s1);
        mTts.setParameter(SpeechConstant.VOICE_NAME, s1); //设置发音人
        ...
        mTts.setParameter(SpeechConstant.TTS_AUDIO_PATH, CacheManager.getInstance().getRootDir() + "/iflytek.pcm");
    }
